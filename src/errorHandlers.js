...
exports.catchAllHandler = exports.notFoundHandler = exports.forbiddenHandler = exports.unauthorizedHandler = exports.badRequestHandler = void 0;
const mongoose_1 = __importDefault(require("mongoose"));
const badRequestHandler = (err, req, res, next) => {
    console.log(err instanceof mongoose_1.default.Error.ValidationError);
